...
object RedWarehouseTrajectoryGen {
    ...
    private val startPose = Pose2d(-12.0, -44.0, 90.0.toRadians)
    private val pose2 = Pose2d(-12.0, -56.0, 90.0.toRadians)
    private val pose3 = Pose2d(-12.0, -56.0, 180.0.toRadians)
    ...
    fun createTrajectory(): ArrayList<Trajectory> {
        ...
        val builder3 = TrajectoryBuilder(pose3, pose3.heading, combinedConstraints)
        val builder4 = TrajectoryBuilder(homePose, homePose.heading, combinedConstraints)
...
val Double.toRadians8 get() = (Math.toRadians(this))
