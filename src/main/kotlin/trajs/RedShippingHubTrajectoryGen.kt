...
object RedShippingHubTrajectoryGen {
    ...
    private val homePose = Pose2d(9.0, -62.0, 90.0.toRadians) // The pose where the bot starts at the start of Auton is called HomePose
...
val Double.toRadians7 get() = (Math.toRadians(this))
